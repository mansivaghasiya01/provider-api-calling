...
//---------------------------------UI------------------------------------//
          ...
          body: SizedBox(
            child: deerProvider.loading
                ...
                : listViewBuilder(deerProvider: deerProvider),
          ),
        );
      },
    );
  ...
  Widget listViewBuilder({required DeerProvider deerProvider}) {
    return ListView.builder(
      itemCount: deerProvider.post.data!.length,
      itemBuilder: (context, index) {
        return cardItems(deerProvider: deerProvider, index: index);
      },
    );
  }

  Widget cardItems({required DeerProvider deerProvider, required index}) {
    return Padding(
            ...
            children: [
                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            Expanded(
                              child: Text(
                                deerProvider.post.data![index].name,
                                style: const TextStyle(
                                    fontSize: 16,
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Expanded(
                              child: Text(
                                deerProvider.post.data![index].tagline,
                                style: const TextStyle(
                                  overflow: TextOverflow.ellipsis,
                                ),
                                maxLines: 1,
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Expanded(
                              child: Text(
                                deerProvider.post.data![index].firstBrewed,
                              ),
                            ),
                          ],
                        ),
              ...
              Row(
                ...
                children: [
                  ...
                  Expanded(
                    child: Text(
                      deerProvider.post.data![index].description,
                      style: const TextStyle(
                        overflow: TextOverflow.ellipsis,
                      ),
                      maxLines: 4,
